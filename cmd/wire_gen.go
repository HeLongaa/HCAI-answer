...
func initApplication(debug bool, serverConf *conf.Server, dbConf *data.Database, cacheConf *data.CacheConf, i18nConf *translator.I18n, swaggerConf *router.SwaggerConfig, serviceConf *service_config.ServiceConfig, uiConf *server.UI, logConf log.Logger) (*pacman.Application, func(), error) {
	...
	externalNotificationService := notification.NewExternalNotificationService(dataData, userNotificationConfigRepo, followRepo, emailService, userRepo, externalService, noticequeueService, userExternalLoginRepo, siteInfoCommonService)
	...
	tagController := controller.NewTagController(tagService, tagCommonService, rankService, realtimeService)
	...
	aiChatConfigService := ai_chat_config2.NewAIChatConfigService(aiChatConfigRepo, userRepo, serviceConf)
	...
	aiConversationService := ai_conversation2.NewAIConversationService(aiConversationRepo)
